...
<div align="center">
  <h3>
    <a href="https://devchallenges-cat-wiki.vercel.app/">
      Demo
    </a>
    <span> | </span>
    <a href="https://github.com/durashere/devchallenges-cat-wiki">
      Solution
    </a>
    <span> | </span>
...
- [x] On mobile, when I select the search option, a modal for breed search should pop up
- [ ] I can go to an article about cats when I click read more on Why you should have a cat section (optional)
- [x] I can go to the top 10 cats by clicking see more in the dashboard (optional)
